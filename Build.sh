...
cp SyncAgent-read/target/org.wso2.custom.user.operation.event.listener-1.0-SNAPSHOT.jar $home_path/repository/components/dropins/
...
cd dropins/* $home_path/repository/components/dropins/
